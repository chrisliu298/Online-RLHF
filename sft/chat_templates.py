...
chat_templates = {
    "Meta-Llama-3-8B": AutoTokenizer.from_pretrained(
        "/mnt/data/yuhaoliu/models/hf_models/Meta-Llama-3-8B"
    ).chat_template,
    "Meta-Llama-3.1-8B": AutoTokenizer.from_pretrained(
        "/mnt/data/yuhaoliu/models/hf_models/Meta-Llama-3.1-8B"
    ).chat_template,
    "gemma-2-9b": AutoTokenizer.from_pretrained(
        "/mnt/data/yuhaoliu/models/hf_models/gemma-2-9b"
    ).chat_template,
